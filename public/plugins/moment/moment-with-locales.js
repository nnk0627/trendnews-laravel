;(function (global, factory) {
    ...
    function createAdder(direction, name) {
        return function (val, date) {
            ...
            if (date !== null && !isNaN(+date)) {
                deprecateSimple(name, 'moment().' + name  + '(date, number) is deprecated. Please use moment().' + name + '(number, date). ' +
                'See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info.');
                tmp = val; val = date; date = tmp;
            }

            val = typeof val === 'string' ? +val : val;
            dur = createDuration(val, date);
    ...
    /**
     * @param withoutSuffix boolean true = a length of time; false = before/after a date of time.
     */
